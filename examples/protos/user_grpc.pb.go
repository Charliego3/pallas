...
const (
	User_Register_FullMethodName = "/protos.User/Register"
	User_Login_FullMethodName    = "/protos.User/Login"
)
...
func (c *userClient) Register(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*LoginReply, error) {
	out := new(LoginReply)
